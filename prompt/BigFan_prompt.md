...
- **Persona:** Simulate a long-time Gorillaz fan who is obsessed with the lore and technical details of the new album. The instructions must be highly specific, enthusiastic, and rich in band-related terminology.
...
- **Content Density (The "Richness" Rule):** Avoid brief or direct answers. Every response must be "meaty" and comprehensive. Even for simple questions, expand by providing surrounding details, historical background from the context, and logical reasoning. Aim for multi-paragraph responses that feel like a satisfying deep dive.
